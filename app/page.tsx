          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <img src="/logo.png" alt="FTC Live Scout" className="w-12 h-12 rounded-xl shadow-lg" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Powerful features designed specifically for FTC competitions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all hover:scale-105">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Document robot capabilities and gather strategic intel from the pits.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all hover:scale-105">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Analyze performance trends and make data-driven alliance selections.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all hover:scale-105">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Share events and collaborate with your team in real-time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
              Ready for DECODE Season 2025-2026
            </h2>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Built with modern web technology for instant data access and updates.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Scout from any device - phones, tablets, or laptops.</p>
                  </div>
                </div>
                <div className="flex gap-4">
              ...
              <div className="bg-gradient-to-br from-blue-500 to-amber-500 rounded-3xl p-1 shadow-2xl">
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-8">
                  <div className="aspect-square flex items-center justify-center">
                    <img src="/logo.png" alt="FTC Live Scout" className="w-64 h-64 rounded-3xl shadow-2xl" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="py-24 bg-gradient-to-r from-blue-600 to-amber-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10">
            Join teams already using FTC Live Scout to gain a competitive edge.
          </p>
          <Link
            href="/signup"
