    ...
    (<div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-amber-50/30 dark:from-gray-950 dark:via-blue-950/20 dark:to-amber-950/20 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-800/50 p-8 space-y-8">
          ...
          {/* Mission Section */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('Our Mission')}</h2>
          ...
          {/* Features Section */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('Key Features')}</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 rounded-2xl border border-blue-200 dark:border-blue-800">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('Match Scouting')}</h3>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 p-6 rounded-2xl border border-amber-200 dark:border-amber-800">
                <div className="text-3xl mb-3">🔧</div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('Pit Scouting')}</h3>
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  {t(
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-6 rounded-2xl border border-purple-200 dark:border-purple-800">
                <div className="text-3xl mb-3">📊</div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('Analytics')}</h3>
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  {t(
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-6 rounded-2xl border border-green-200 dark:border-green-800">
                <div className="text-3xl mb-3">🤝</div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t('Team Collaboration')}</h3>
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  {t(
          ...
          {/* Technology Section */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('Built With Modern Technology')}</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm font-semibold text-gray-900 dark:text-white">{t('Next.js')}</p>
              </div>
              <div className="text-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="text-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                <div className="text-2xl mb-2">🎨</div>
                <p className="text-sm font-semibold text-gray-900 dark:text-white">{t('Tailwind CSS')}</p>
              </div>
              <div className="text-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                <div className="text-2xl mb-2">☁️</div>
                <p className="text-sm font-semibold text-gray-900 dark:text-white">{t('Appwrite')}</p>
              </div>
            </div>
          </section>
          ...
          {/* Created By Section */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('Created By')}</h2>
            <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-amber-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-amber-900/20 p-8 rounded-2xl border border-gray-200 dark:border-gray-700">
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="flex-shrink-0">
                  <img src={t('/FTC 19666 Logo.svg')} alt={t('FTC Team 19666')} className="w-32 h-32 md:w-40 md:h-40" />
                </div>
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                    {t('FTC Team 19666 - Forever Knight Robotics')}
                  </h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    {t(
          ...
          {/* About FTC Section */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('About FIRST Tech Challenge')}</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              {t(
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('Support & Feedback')}</h2>
          ...
          <section className="pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="text-center text-sm text-gray-500 dark:text-gray-400">
              <p className="mb-2">{t('© 2025 FTC Live Scout. All rights reserved.')}</p>
              <p className="mb-3">
                {t('Made with ❤️ for the FIRST Tech Challenge community')}
              </p>
              <div className="flex items-center justify-center gap-2 text-xs">
                <img src={t('/FTC 19666 Logo.svg')} alt={t('FTC Team 19666')} className="w-6 h-6" />
                <span>{t('Created by FTC Team 19666 - Forever Knight Robotics')}</span>
              </div>
            </div>
          </section>
        </div>
